...
def seed_friends():
    ...
    friend1 = Friend(user_id=1, friend_id=2, is_accepted=True)
    friend2 = Friend(user_id=2, friend_id=3, is_accepted=True)
    friend3 = Friend(user_id=1, friend_id=3, is_accepted=False)
    friend4 = Friend(user_id=4, friend_id=1, is_accepted=False)
